 ...
 * @param keypair 
 */
export async function startInscribeMint(keypair: ECPairInterface) {
  // TapTree example
  console.log(`Running "startInscribeMint"`);
  ...
  const textdata = Buff.encode(`{ "p": "brc-20", "op": "mint", "tick": "cccc", "amt": "100" }`);
  ...
  console.log('Your address1:', address)
