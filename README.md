...
- _[Sovereign Individuals](https://www.amazon.sg/Sovereign-Individual-Mastering-Transition-Information/dp/0684832720)_, [Chinese translation download](https://drive.google.com/file/d/1f113cCsSKtH_05S5gJCmoBvqItufH-_j/view?usp=sharing).
...
49. [solidity security](basic/50-solidity-security) ✅
50. [sniper](https://github.com/Supercycled/cake_sniper.git) ⬜
51. [Governance](https://github.com/withtally/safeguard) ⬜
52. [Freelancer's Smart Contract](basic/53-freelancer) ✅
53. [Cryptovoxels](https://zhuanlan.zhihu.com/p/379249411) ⬜
54. [PBFT](https://medium.com/loom-network-chinese/%E4%BA%86%E8%A7%A3%E5%8C%BA%E5%9D%97%E9%93%BE%E7%9A%84%E5%9F%BA%E6%9C%AC-%E7%AC%AC%E4%B8%80%E9%83%A8%E5%88%86-%E6%8B%9C%E5%8D%A0%E5%BA%AD%E5%AE%B9%E9%94%99-byzantine-fault-tolerance-8a1912c311ba) ⬜
55. [IDO](https://github.com/gnosis/ido-contracts) ⬜
56. [Orbit model](https://github.com/orbit-love/orbit-model) ⬜
57. [snapshot](basic/40-snapshot) ⌛
58. [wagmi and nextjs](basic/59-wagmi-and-nextjs) ⌛
59. [Referral Code](https://developers.thundercore.com/docs/referral-contract/) ⬜
60. [ENS](basic/61-ENS) ✅
61. [Tenderly](https://dashboard.tenderly.co/explorer)
62. [HTLC-crosschain](basic/63-htlc-crosschain) ✅
63. [state channel](https://ethereum.org/en/developers/docs/scaling/state-channels/) ⬜
64. [ZK-NFT](https://github.com/kevinz917/zk-NFT)
65. [Kleros](https://kleros.io/)
66. [Go-Ethereum Code Analysis](basic/67-Go-Ethereum-Code-Analysis/readme.md)
67. [Config discord with Collab.land](basic/68-config-discord-with-Collab.land) ✅
68. [Decentralized OTC](https://github.com/DOTCPro)
69. [Arweave file upload with Bundlr Client](basic/70-arweave-file-upload-with-bundlr/README.md)
70. [NYM](https://myz1237.substack.com/p/nymwhitepaper?r=uaq4w&utm_campaign=post&utm_medium=web&utm_source=) ⬜
71. [Unlock protocol](https://docs.unlock-protocol.com/unlock/developers/unlock-platform)
72. [onchainNFT](https://github.com/Park-City-Utah/onChainNFT)
73. [erc20-meta-token](https://github.com/0xsequence/erc20-meta-token)
74. [golang-dapp](basic/75-golang-dapp) ✅
75. [Push Protocol](https://docs.epns.io/developers)
76. [orbit](basic/77-orbit)
77. [wallet connect](basic/78-wallet-connect)
78. [hardhat-foundry](basic/79-hardhat-foundry)
79. [Circle CCTP](basic/80-circle-cctp)
...
- 7.  [Infura](https://www.infura.io/platform/nft-api)
