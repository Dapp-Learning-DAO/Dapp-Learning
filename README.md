...
- [Dapp-Learning-Sourcecred](https://github.com/rebase-network/Dapp-Learning-Sourcecred): 记录开发者贡献值，以及分发奖励，dao治理项目的工具之一。
- [Medal of Honour](https://github.com/rebase-network/Dapp-Learning-MOH) : 每位参与者发放nft纪念。
