...
The project adheres to the concept of [open source university](https://github.com/rebase-network/Rebase-University) and will manage the open source project in the form of Dao governance.  This project is sponsored by [Ethereum foundation](https://esp.ethereum.foundation/en/), and we will reward the outstanding contributors of the project. Welcome to our Twitter [DAPP learning twitter](https://twitter.com/Dapp_Learning). The project can read the Rebase official account [welcome to Dapp-Learning](https://mp.weixin.qq.com/s/79eRMtB_yz8G6H8_saCeLw).
