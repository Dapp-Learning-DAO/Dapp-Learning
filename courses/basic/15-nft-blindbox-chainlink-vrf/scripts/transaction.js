...
//     * Key Hash: 0x6c3699283bda56ad74f6b855546325b68d482e983852a7a82979cc4807b641f4
  ...
  //  const Dnd = await hre.ethers.getContractFactory("DungeonsAndDragonsCharacter");
    ...
    const dndaddress = "0xe015B0F54adEDa9B2B1Cd6D4214E7D542Dd83CfC";
   // const dnd = await Dnd.deploy(Coordinator, LINK, KeyHash);
    const dnd = await hre.ethers.getContractAt("DungeonsAndDragonsCharacter",dndaddress);
    ...
    await dnd.requestNewRandomCharacter(77, "The Chainlink Knight");
    
    console.log("request vrf random successfully!");
