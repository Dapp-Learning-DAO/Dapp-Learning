...
adjustPositionForLiquidityChanged函数主要调用calcPositionAfterLiquidityMigration函数；
...
```
 ...
 1. 开仓函数第一个主要函数是：
  ...
  其中主要调用了calcBaseAssetAfterLiquidityMigration，根据eth大小计算出
 ...
 而calcPositionAfterLiquidityMigration 调整用户仓位核心函数
