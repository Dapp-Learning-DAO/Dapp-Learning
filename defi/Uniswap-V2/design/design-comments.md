...
<img src="https://latex.codecogs.com/svg.image?\text{WAM}_{priceA}=\frac{1}{\text{WHM}_{priceB}}" />
...
<img src="https://latex.codecogs.com/svg.image?\small\text{WGM}_{priceA}=\frac{1}{\small\text{WGM}_{priceB}}" />
