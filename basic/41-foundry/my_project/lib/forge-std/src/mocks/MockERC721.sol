...
contract MockERC721 is IERC721Metadata {
    ...
    function safeTransferFrom(address from, address to, uint256 id) public payable virtual override {
        ...
        require(
            !_isContract(to) || IERC721TokenReceiver(to).onERC721Received(msg.sender, from, id, '') == IERC721TokenReceiver.onERC721Received.selector,
            'UNSAFE_RECIPIENT'
        );
    }
    ...
    function safeTransferFrom(address from, address to, uint256 id, bytes memory data) public payable virtual override {
        ...
        require(
            !_isContract(to) ||
                IERC721TokenReceiver(to).onERC721Received(msg.sender, from, id, data) == IERC721TokenReceiver.onERC721Received.selector,
            'UNSAFE_RECIPIENT'
        );
    }
    ...
    function _safeMint(address to, uint256 id) internal virtual {
        ...
        require(
            !_isContract(to) ||
                IERC721TokenReceiver(to).onERC721Received(msg.sender, address(0), id, '') == IERC721TokenReceiver.onERC721Received.selector,
            'UNSAFE_RECIPIENT'
        );
    }
    ...
    function _safeMint(address to, uint256 id, bytes memory data) internal virtual {
        ...
        require(
            !_isContract(to) ||
                IERC721TokenReceiver(to).onERC721Received(msg.sender, address(0), id, data) == IERC721TokenReceiver.onERC721Received.selector,
            'UNSAFE_RECIPIENT'
        );
    }
