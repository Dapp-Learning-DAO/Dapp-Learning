...
contract StdAssertionsTest is StdAssertions {
    ...
    function testFuzz_RevertWhenCalled_AssertEqCall_Return_Fail(
        ...
        vm._expectCheatcodeRevert(
            bytes(string.concat('Call return data does not match: ', vm.toString(returnDataA), ' != ', vm.toString(returnDataB)))
        );
        assertEqCall(targetA, callDataA, targetB, callDataB, strictRevertData);
    }
    ...
    function testFuzz_RevertWhenCalled_AssertEqCall_Revert_Fail(
        ...
        vm._expectCheatcodeRevert(
            bytes(string.concat('Call revert data does not match: ', vm.toString(revertDataA), ' != ', vm.toString(revertDataB)))
        );
    ...
    function assertEqCallExternal(address targetA, bytes memory callDataA, address targetB, bytes memory callDataB, bool strictRevertData) public {
        assertEqCall(targetA, callDataA, targetB, callDataB, strictRevertData);
    }
