...
contract CatBlindbox is  VRFConsumerBase, Ownable, MYERC721 {
    ...
    */
    ...
    internal override
    {
        ...
        mintWithAssetURI(requestToSender[requestId], nftId, catSpecies.images);
